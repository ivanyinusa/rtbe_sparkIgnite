...
```scala
import sparkworkshop.util.FileUtil
import org.apache.spark.SparkContext
import org.apache.spark.SparkContext._
```
...
```scala
import sparkworkshop.util.{CommandLineOptions, FileUtil, TextUtil}
import org.apache.spark.SparkContext
import org.apache.spark.SparkContext._
```
...
```scala
package hadoop
import sparkworkshop.util.Hadoop
...
```scala
import sparkworkshop.util.Matrix
...
...
```scala
import sparkworkshop.util.Verse
