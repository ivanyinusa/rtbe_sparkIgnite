...
object GradientBoostedTreesRunner {
  ...
  def run(params: Params) {
    ...
    //val boostingStrategy.treeStrategy.numClasses = numClasses
    //val boostingStrategy.numIterations = params.numIterations
    //val boostingStrategy.treeStrategy.maxDepth = params.maxDepth
